    ...
    <table style={tableStyles}>
      <thead >
        ...
        <td style={headerCellStyles}>Number</td>
          ...
          <td style={headerCellStyles}>Document Title / Document Type</td>
	...
	return (
		...
		>
			...
			<Box sx={{ mx: globalStyles.mx, backgroundColor: "", flex: 1 }}>
				<Box sx={{ width: "100%", mt: "3vh" , display:"flex", justifyContent: "space-between"}}>
					<Typography lineHeight={1.1} sx={{ fontSize: "20px" }}>
						Report Preview
					</Typography>
					<Divider sx={{ height: "30px", width: 0 }} />
                    <Box>
                    <Button sx ={{textTransform :'None', color:'black', fontSize:'16px', lineHeight:'1.1', fontWeight:"lighter"}}> Delete Report</Button>
                    <Button sx ={{textTransform :'None', color:'black', fontSize:'16px', lineHeight:'1.1'}}> Enhance Report</Button>
                    </Box>
				</Box>
      ...
      >
         ...
         <Box sx={{display:"flex",  width: " 590px", justifyContent:"space-between"}}>
...
>
           ...
           {/*} <Box sx={{display:'flex',justifyContent:"space-between"}}>*/}
            <Box sx={{justifySelf:"center"}}>
                <Typography id="modal-modal-title" variant="h6" component="h2" align="center" justifySelf="center">
            Save Report
            </Typography>
            </Box>
           ...
           {/*</Box>*/}
            ...
            <Divider sx={{ borderBottomWidth: 1.5  }} style={{ background: 'black' }} />
            <Typography id="modal-modal-description" sx={{ mt: 2 }}>
            How do you want to save your report?
            </Typography>
            <Divider sx={{ height: "15px", width: 0 }} />
            <Box>
            <FormControlLabel control={<Checkbox defaultChecked />} label="Save as new report" />
            ...
            <Divider sx={{ height: "30px", width: 0 }} />
            <FormControlLabel control={<Checkbox defaultChecked />} label="Save and add to existing report" />
            <Divider sx={{ height: "15px", width: 0 }} />
            { <RoundedDropdown
					headerText={''}
          ...
          <Button onClick={handleClose} variant = "contained" color="secondary" sx={ { borderRadius: 60, backgroundColor: 'LightGray', textTransform: 'none', minWidth:200, color:'black'}}>
                 Cancel </Button>
          <Divider sx={{ height: "10px", width: 0 }} />
            <Button onClick={handleSnackBarModalClose} type="submit" title={'Test'}  variant = "contained" color="secondary" sx={ { borderRadius: 60, backgroundColor: 'LightGray', textTransform: 'none', minWidth:200, color:'black'}}>
                Save
            </Button>
            <Divider sx={{ height: "15px", width: 0 }} />
            </Box>
      ...
      >
         ...
         action={
    <Button color="inherit" size="large" onClick={handleSnackBarClose}>
      X
    </Button>
  }>
    <Typography ><strong>Successful</strong>  </Typography><br />
    Your report is saved successfully.
			...
			>
        <Button type="submit" title={'Test'}  color="secondary" sx={ {  textTransform: 'none', minWidth:200, color:'white', fontSize:20} } >Back </Button>
        <Box sx={{display:"flex",  width: " 450px", justifyContent:"space-between"}}>
        <Button onClick={handleOpen} variant = "contained" color="secondary" sx={ { borderRadius: 60, backgroundColor: 'LightGray', textTransform: 'none', minWidth:200, color:'black'}}>Save Report</Button>
        <Button variant = "contained" color="secondary" sx={ { borderRadius: 60, backgroundColor: 'LightGray', textTransform: 'none', minWidth:200, color:'black'}}> Export Report</Button>
        </Box>
        </Box>
